...
Gem::Specification.new do |s|
  ...
  s.files           = Dir['{app,lib,config,vendor}/**/*'] + %w(MIT-LICENSE Rakefile Gemfile README.md)
  s.authors         = ['Akshay Rawat', 'Timo Schilling', 'Michael Johann']
  s.email           = ['projects@akshay.cc']
  s.homepage        = 'https://github.com/malagant/dj_mon'
